...
import {ArticleListCardStyle2} from '..'
...
const ArticleTabSelectorList = ({tabHeadings}) => {
    ...
    const StyledTab = styled((props) => <Tab disableRipple {...props} />)(({ theme }) => ({
        ...
        color: '#3F3D56',
        backgroundColor: 'rgba(48, 199, 181, 0.40)',
        fontFamily: [
          'Poppins',
          '-apple-system',
          'BlinkMacSystemFont',
        ...
        '&.Mui-selected': {
          color: '#30c7b5',
          backgroundColor: 'rgba(63, 61, 86, 0.85)',
    ...
    return (
        ...
        <Tabs
            ...
            >
            <StyledTab label={tabHeadings[0]} {...a11yProps(0)} />
            <StyledTab label={tabHeadings[1]} {...a11yProps(1)} />
            <StyledTab label={tabHeadings[2]} {...a11yProps(2)} />
            <StyledTab label={tabHeadings[3]} {...a11yProps(3)} />
            <StyledTab label={tabHeadings[4]} {...a11yProps(4)} />
            <StyledTab label={tabHeadings[5]} {...a11yProps(5)} />
            <StyledTab label={tabHeadings[6]} {...a11yProps(6)} />
            <StyledTab label={tabHeadings[7]} {...a11yProps(7)} />
        </Tabs>
...
export default ArticleTabSelectorList;