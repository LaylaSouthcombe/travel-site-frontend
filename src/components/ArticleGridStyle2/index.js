...
import {ArticleCardStyle1} from '..'

const ArticleGridStyle2 = () => {
...
const article = {
    ...
    return (
        <div className="articleGridStyle2">
            <div className="style2column1">
                <ArticleCardStyle1 article={article}/>
            </div>
            <div className="style2column2">
                <ArticleCardStyle1 article={article}/>
            </div>
            <div className="style2column3">
                <ArticleCardStyle1 article={article}/>
            </div>
            <div className="style2column4">
                <ArticleCardStyle1 article={article}/>
            </div>
        </div>
    )
