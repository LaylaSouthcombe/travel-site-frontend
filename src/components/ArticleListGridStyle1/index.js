...
const article = {
    ...
    return (
        <div className="articleListGridStyle1">
            <div className="liststyle1column1">
                <ArticleListCardStyle3 article={article}/>
                <ArticleListCardStyle3 article={article}/>
                <ArticleListCardStyle3 article={article}/>
                <ArticleListCardStyle3 article={article}/>
            </div>
            <div className="liststyle1column2">
                <ArticleListCardStyle3 article={article}/>
                <ArticleListCardStyle3 article={article}/>
                <ArticleListCardStyle3 article={article}/>
                <ArticleListCardStyle3 article={article}/>
...
export default ArticleListGridStyle1;