    ...
    return (
        <>
            ...
            <div className="legalContent">
                ...
                <p>By visiting and using www.sojo-travels.com (hereinafter the “website”), you accept and agree to be bound by these Terms and Conditions including our Disclaimer and Privacy Policy posted on the website and incorporated herein by reference.</p>
                <p>The term “you” refers to anyone who uses, visits and/or views the website. The Petite Blogger  (“company”, “I”, “we” or “us”) reserves the right to amend or modify these terms and conditions in its sole discretion at any time without notice and by using the website, you accept those amendments.  It is your responsibility to periodically check the website for updates.</p>
                <p>Your continued use of the website after posting of any changes to our Terms and Conditions constitutes your acceptance of those changes and updates. You must not access or use the website if you do not wish to be bound by these Terms and Conditions.</p>
                ...
                <h2>MANDATORY ARBITRATION AND GOVERNING LAW</h2>
                <p>You expressly waive your right to bring any legal claims, now or in the future arising out of or related to the website and our products/services. In the event of any dispute, claim or controversy arising out of or relating to your use of this website, the terms and conditions shall be construed in accordance with the rules and regulations of the state of United Kingdom and the United States.</p>
                <p>You agree to consent and submit to the jurisdiction of the state and federal courts located in United Kingdom without regard to the principles of conflict of law or where the parties are located at the time a dispute arises.</p>
                <p>You agree to resolve any disputes or claims first through mandatory arbitration in the state of United Kingdom and shall bear the full cost of arbitration as permitted by law. Your good faith participation in arbitration is a condition precedent to pursuing any other legal or equitable remedies available such as litigation or any other legal procedure. You also agree that in the event a legal claim is initiated after the required arbitration, the prevailing party shall be entitled to recover reasonable attorney’s fees and other costs associated with the legal action.</p>
                ...
                <h2>USER CONTENT AND LAWFUL USE OF THE WEBSITE</h2>
                ...
                <ul>
                    <li>(a) illegal, violates or infringes upon the rights of others,</li>
                    <li>(b) defamatory, abusive, profane, hateful, vulgar, obscene, libelous, pornographic, threatening,</li>
                    <li>(c) encourages or advocates conduct that would constitute a criminal offense, giving rise to civil liability or otherwise violate any law,</li>
                    <li>(d) distribute material including but not limited to spyware, computer virus, any kind of malicious computer software or any other harmful information that is actionable by law,</li>
                    <li>(e) any attempts to gain unauthorized access to any portion or feature of the website, and</li>
                    <li>(f) send unsolicited or unauthorized material or cause disruption in the operation of the website. You agree to use the website for lawful purposes only and shall be liable for damages resulting from the violation of any provision contained in these Terms and Conditions.</li>
                </ul>
                ...
                <h2>USE OF OUR PAID AND FREE PRODUCTS</h2>
                ...
                <h2>CONTACT</h2>
                <p>For any questions, please contact us at help@sojotravels.com.</p>
            </div>
            <BottomMenu/>
        </>
    )
