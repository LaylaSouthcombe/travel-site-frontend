    ...
    return (
        <>
            ...
            <div className="legalContent">
                ...
                <p><strong>Sojo Travels</strong> (“company”, “I”, “we” or “us”) is dedicated to respecting the privacy of your personal information, and this privacy policy describes what information is collected from you on <strong>www.sojo-travels.com</strong> (hereinafter the “website”) and how it is used. The term “you” refers to anyone who uses, visits and/or views the website.</p>
                <p><strong>By visiting and using the website, you accept and agree to be bound by this privacy policy. Your continued use of the website after posting of any changes to our Privacy Policy constitutes your acceptance of those changes and updates. You must not access or use the website if you do not wish to be bound by this Privacy Policy.</strong></p>

                <h2>CHILDREN'S PRIVACY</h2>
                <p>We respect the privacy of children and “child” means an individual under the age of 13. All information and content on this website is intended for individuals over the age of 18. Children under the age of 13 are prohibited from using this website. We do not knowingly collect, use or disclose personal information from children under the age of 13 without prior parental or guardian consent. If you believe any personal information is collected from someone under the age of 13 without parental or guardian consent, then please contact us to have that information deleted.</p>

                <h2>WHAT INFORMATION WE COLLECT AND HOW IT IS USED</h2>
                <p>When you access the website, you may provide certain personally identifiable information including but not limited to your name, email address, phone number, address, avatar image, credit card information when you make a purchase on the website.</p>
                ...
                <p>Additionally, like other websites, this website automatically collects certain information about you through Log Data and Google Analytics. Log Data is information about your computer's Internet Protocol Address, which is your “IP” address, browser information, Internet Service Provider's information, your operating system, and your browser type. Similarly, Google Analytics collects certain information about your location, browsing history, the pages you visit, the equipment you used to access the website, traffic patterns, and other general patterns related to your use of the website.</p>
                <p>This information is used to analyze website statistics related to user behavior and interests, improve our performance and your use of the website and to further enhance our products and services offered to you.</p>

                <h2>COMMENTS AND SOCIAL MEDIA</h2>
                <p>If you leave a comment, the comment and its metadata are retained indefinitely. This is so we can recognize and approve any follow-up comments automatically instead of holding them in a moderation queue. When you leave a comment, your name, email address and website/organization name is not shared with a third party and may be used to communicate with you.</p>
                <p>Social media accounts and sharing options are available on this website. Social media sites (Facebook, Twitter, YouTube, and so forth) can track your personal information. Should you choose to interact with us on social media, please note that you will be voluntarily disclosing that personal information. This information is no longer private. It becomes public information and can be collected and used by others. We have no control over and take no responsibility for the use, storage or dissemination of such publicly-disclosed personal information by you.</p>
                <p>Any such interactions via comments and social media with us do not subject us to any kind of liability related to misuse of your information by others.</p>
                ...
                <h2>USE OF WEB BEACONS AND PIXELS</h2>
                <p>In conjunction with the use of cookies, third parties may also use web beacons, which are also known as clear GIFs, web bugs or pixel tags to collect general information about your use of our website. They monitor user activity and are used to track customer behavior data. This information may be relevant to third parties such as the ad networks used on our website to tailor the advertising based on your behavior and interests.</p>
                <p>We may use social media pixels to track and collect general information about your use in compliance with different social media sites (Facebook, Twitter, etc) for the purpose of promoting products, tracking conversions, remarketing, running target advertisements and so forth.</p>
                <p>Third parties like Facebook may use their own cookies, web beacons and other technologies to collect and receive information from our website for the purpose of providing target advertisements. You may see our ads on Facebook after you have visited our website. </p>

                <h2>THIRD-PARTY LINKS AND USE</h2>
                <p>We may include, offer or advertise third party links, products or services on the website. Once you click on a third-party link and leave this website, you are no longer bound by our Privacy Policy and Terms and Conditions.</p>
                <p>Articles on this website may include embedded content (e.g. videos, images, advertisements, etc.). Embedded content from other websites behaves in the exact same way as if the visitor has visited the other website. These websites may collect data about you, use cookies, embed additional third-party tracking, and monitor your interaction with that embedded content, including tracing your interaction with the embedded content if you have an account and are logged in to that website.</p>
                <p>We may use Google AdSense advertising along with any other third-party advertising on the website. Google is a third party that also uses cookies to serve ads on the website for the purpose of providing a positive user experience. Third-party vendors such as Google use cookies to serve ads based on a user's prior visits to the website. You can opt-out of Google by visiting their privacy policy and ad settings.</p>
                <p>We have no control over these third parties and they have their own privacy policies. Neither are we responsible for the activities and practices of these third parties. You should contact them directly and read their privacy policies for any questions. You also agree that your use of these third-party websites is solely at your risk.</p>
                ...
                <ol>
                    ...
                    <li>We may disclose your information in order to comply with state or federal regulations related to copyright infringement lawsuits or any other legal claims related to the website.</li>
                ...
                <h2>OPT-OUT</h2>
                <p>We comply with the CAN-SPAM Act of 2003 and do not spam or send misleading information. Should you wish to no longer receive communication from us, you have the option of unsubscribing by clicking “unsubscribe” at the bottom of the email we send to you or by contacting us.</p>
                ...
                <ol>
                    <li>You ask us to delete the information by sending a request to help@sojotravels.com. Please note that such requests may result in you no longer being able to access paid or free content previously provided to you.</li>
                ...
                <p>You have the right to request access to your data that we store and have the ability to access your personal data.</p>
                ...
                <h2>YOUR RIGHTS UNDER THE CALIFORNIA CONSUMER PRIVACY ACT (CCPA COMPLIANCE)</h2>
                <p>If you reside in California, you are entitled to additional rights under California law and we ensure compliance with the CCPA. Here are your rights:</p>
                <ol>
